...
public class Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 30, 290, 40));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            con = getConnection();
            ps = con.prepareStatement("insert into user(Nombre,Apellido,Usuario,Clave,Email,Telefono) values (?,?,?,?,?,?)");
